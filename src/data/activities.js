// Import cover images
import kdbiCover from '../assets/images/competition/kdbiCover.png';
import edcCover from '../assets/images/competition/edcCover.png';
import scpCover from '../assets/images/competition/scpCover.png';
import smcCover from '../assets/images/competition/smcCover.jpg';
...
import edcSlidingIcon from '../assets/icons/smile-face.png';
import spcSlidingIcon from '../assets/icons/book.png';
import smcSlidingIcon from '../assets/icons/movie-clapper.png';
import internationalSeminarIcon from '../assets/icons/semin.png';
...
export function getActivityPaths() {
  return activities.map(activity => ({ 
    params: { slug: activity.path } 
  }));
}

export function getActivity(slug) {
  return activities.find(activity => activity.path === slug);
}